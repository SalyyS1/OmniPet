...
The 2026-08-02 clean JDK 21 Gradle build completed successfully with all 18 tasks. It passed 83 suites/290 tests: core 40 suites/164 tests and Paper 43 suites/126 tests, with zero failures, errors, or skips. The single artifact is `build/release/OmniPet-3.0.0-SNAPSHOT.jar` (1,010,248 bytes, SHA-256 `71F381BF1BFBA125CDE35D8883734F8CC09BAAF559680D0DB2AB52588F3325B7`), with 650 entries, 575 classes, one `paper-plugin.yml`, and zero Maven entries. Compatibility probes, crash-injection tests, and live-server smoke were not rerun for this checkpoint.
