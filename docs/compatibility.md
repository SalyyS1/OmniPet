...
Phase 1 compatibility evidence consists of Java/Gradle tests and Paper API compile probes. It does not include a live Paper server smoke test, gameplay certification, or vendor-plugin certification.
...
| --- | ---: | --- | --- |
| `1.21-R0.1-SNAPSHOT` | 21 | Passed | Primary Phase 1 compile baseline only. |
