...
Verification snapshot: 2026-08-03. The clean JDK 21 Gradle build passed all 18 tasks and 158 suites/691 tests with zero failures, errors, or skips. The `1.21` and `1.21.1` compile probes were rerun for this checkpoint because two new Paper API surfaces were introduced; the remaining rows were not rerun.
