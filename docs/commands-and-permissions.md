...
| `/pet admin pet give <player> <definition-id>` | — | `omnipet.admin.petgive` | Grants a pet straight into a vault, bypassing incubation and escrow. Separate permission because it is stronger than handing out an egg. |
